...
def initilize_skeleton_and_skin(path_to_mesh,skeleton_scale = 1,skin_scale = 1):
    ...
    right_sp_no_bone = Joint([0,0,0.3],[0.0,pitch_body,0],parent = root, end_joint_of_bone = False , scale = skeleton_scale, color = 'red', rotation_order = 'zxy',name = 'right_sp_no_bone')
    right_wing_root = Joint([0,-0.3,-0.05],[0.0,0,0], parent = right_sp_no_bone, end_joint_of_bone = False, scale = skeleton_scale, color = 'red',rotation_order = 'zxy',name = 'right_wing_root')
    ...
    left_sp_no_bone = Joint([0,0,0.3],[0.0,pitch_body,0], parent = root, end_joint_of_bone = False, scale = skeleton_scale, color = 'blue',rotation_order = 'zxy',name = 'left_sp_no_bone')
    left_wing_root = Joint([0,0.3,-0.05],[0.0,0,0],parent = left_sp_no_bone, end_joint_of_bone = False, scale = skeleton_scale, color = 'blue',rotation_order = 'zxy',name = 'left_wing_root')
...
#right_wing_large_thin_y2
    ...
    right_wing = Skin(f'{path_to_mesh}/right_wing_thin.stl',scale = skin_scale,constant_weight = right_wing_root,color = 'crimson')
    left_wing = Skin(f'{path_to_mesh}/left_wing_thin.stl',scale = skin_scale, constant_weight = left_wing_root,color = 'dodgerblue')
