...
def build_skeleton(root,body,right_wing,left_wing,skin_translation = torch.tensor([-0.1/1000-1/1000,0,1/1000], device = 'cuda')):
    ...
    right_wing.calculate_weights_dist(right_wing.bones[3:5])
    left_wing.calculate_weights_dist(right_wing.bones[5:])
...
def transform_pose(points,weights,root_rotation,list_joints_pitch_update,joint_list,bones,translation,right_wing_angles,left_wing_angles,right_wing_angles_center,left_wing_angles_center,left_wing_location,right_wing_location):
    ...
    joint_list[6].set_local_translation(right_wing_location)
    joint_list[7].set_local_rotation(right_wing_angles)
    joint_list[8].set_local_rotation(right_wing_angles_center)

    joint_list[10].set_local_translation(left_wing_location)
    joint_list[11].set_local_rotation(left_wing_angles)
    joint_list[12].set_local_rotation(left_wing_angles_center)
